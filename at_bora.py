...
access = "" 
secret = "" 
myToken = "xoxb-2841240555399-2855867422661-98VUWnPfVWkgJnh5rKgyIsSU"
...
while True: 
    try: 
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10): 
           ...
           if target_price < current_price and current_price < predicted_close_price and ma5 < current_price: 
              krw = get_balance("KRW") 
              if krw > 5000: 
           ...
           if BORA > 0.00008: 
               ...
               sell_result=upbit.sell_market_order("KRW-BORA", BORA*0.9995) 
